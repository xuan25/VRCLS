<template>
            <el-text class="mx-1" >
        默认使用开发者云服务器免费测试账户,
        器限制每日800次请求。识别或翻译算一次请求，语音合成算一次请求。每分钟4次请求,
        可通过爱发电支持服务器运维提升日请求上限,
        并解锁请求速率限制,发电方式请加qq群查看群公告<br/><br/>
        可以使用本地识别模型，无限制,延迟较低,但准确度较差<br/>
        本地识别模型会自动下载，也可群内手动下载<br/>
        如果想要完全绕过，请将翻译引擎选用非开发者服务器的翻译<br/><br/>
        如需获取更多服务器资源或技术支持请加qq群1011986554
</el-text>
            <br/><br/>
