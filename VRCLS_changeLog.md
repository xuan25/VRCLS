...
- 修复多开异常问题
- 修复界面重启后首页启用开关状态不同步问题
- 修复vrc同步开关无法通过重启服务正常配置的问题

# v0.6.0-fix1

更新时间：2025/7/9

更新提示：自2025/7/9 v0.6.0以前版本的自动升级失效，请使用以下链接下载安装程序更新：https://cloudflarestorage.boyqiu001.top/VRCLS-windows-v0.6.0-fix1.exe
